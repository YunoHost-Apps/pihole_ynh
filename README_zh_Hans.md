...
[![集成程度](https://apps.yunohost.org/badge/integration/pihole)](https://ci-apps.yunohost.org/ci/apps/pihole/)
![工作状态](https://apps.yunohost.org/badge/state/pihole)
![维护状态](https://apps.yunohost.org/badge/maintained/pihole)
